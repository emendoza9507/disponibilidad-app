                ...
                <div style="max-height: 400px" class="overflow-y-auto">
                    <table class="w-full">
                        ...
                        <tr>
                            ...
                            <th class="px-2 text-end">Cant. Baterias</th>
                        </tr>
                        </thead>
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td>
                                    @if($ot->consecutivoBaterias->count() == 0)
                                        <form action="{{route('consecutivo.bateria.store')}}?connection_id={{$connection_id}}" method="POST">
                                            @csrf
                                            <input type="hidden" name="codigoot" value="{{$ot->CODIGOOT}}">
                                            <button class="px-3 py-0 bg-green-700 hover:bg-green-900 text-white font-bold">GENERAR</button>
                                        </form>
                                    @else
                                        <div class="flex gap-2">
