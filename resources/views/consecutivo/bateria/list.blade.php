        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                ...
                <div class="mt-3 flex justify-between">
                    <h3 class="text-xl font-bold uppercase">Baterias</h3>
                    <div class="text-xl">
                        <b>TOTAL:</b>
                        ...
                        @foreach($consecutivos as $consecutivo)
                            ...
                            <tr class="text-start hover:bg-gray-300">
                                <td class="text-start py-2">
                                    <a href="{{route('consecutivo.bateria.show', $consecutivo->id)}}">
                                    {{$fecha->format('y')}}{{$consecutivo->id}}
                                    </a>
                                </td>
                                <td class="text-start">
                                    <a @isset($consecutivo->connection_id)href="{{route('orden.show', [$consecutivo->CODIGOOT, 'connection_id'=>$consecutivo->connection_id])}}"@endisset>
